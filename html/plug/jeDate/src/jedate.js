...
;(function(window, factory) {
    ...
    function jeDatePick(elem, options){
        var config = {
            ...
            maxDate:getCurrentDate(),              //最大日期
            isShow:true,                                //是否显示为固定日历，为false的时候固定显示
            multiPane:false,                             //是否为双面板，为false是展示双面板
            onClose:false,                               //是否为选中日期后关闭弹层，为false时选中日期后关闭弹层
            range:" 至 ",                                //如果不为空且不为false，则会进行区域选择，例如 " 至 "，" ~ "，" To "
            ...
            method:{},                                 //自定义方法                
            theme:{bgcolor:"#409EFF",pnColor:"#a6ccf3"},//自定义主题色
            shortcut:[],                                //日期选择的快捷方式
        ...
        methodEventBind : function() {
            ...
            jet.extend(that,{
                ...
                clearBtn:function () {
                    ...
                    that.closeDate();
                    opts.donefun && opts.donefun.call(that,{elem:that.valCell,val:null,date:[]}); 
                },
                //现在按钮函数
                nowBtn:function () {
